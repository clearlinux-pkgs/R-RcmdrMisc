...
Version  : 2.7.1
Release  : 29
URL      : https://cran.r-project.org/src/contrib/RcmdrMisc_2.7-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RcmdrMisc_2.7-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597329510
