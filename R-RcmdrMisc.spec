...
Version  : 2.5.0
Release  : 5
URL      : https://cran.r-project.org/src/contrib/RcmdrMisc_2.5-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RcmdrMisc_2.5-0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1534773488
